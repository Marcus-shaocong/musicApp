var searchD = require('../data/searchData.js');
...
Page({
  ...
  getSearchKeyword() {
    ...
    that.setData({
      historyKeyword: searchD.historyKeywordList,
      defaultKeyword: searchD.defaultKeyword,
      hotKeyword: searchD.hotKeywordList
    });
  },
  ...
  getHelpKeyword: function () {
    ...
    util.request(api.SearchHelper, { keyword: that.data.keyword }).then(function (res) {
      if (res.errno === 0) {
        console.log("searchHelper.res", res);
        that.setData({
